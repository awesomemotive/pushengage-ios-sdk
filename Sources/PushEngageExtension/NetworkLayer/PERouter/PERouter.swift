...
package enum NotificationAction {
    case viewed
    case clicked
}

public typealias Parameters = [String: Any]
package typealias NotificationCycleStatus = (hash: String,
                                            notificationId: String,
                                            action: NotificationAction,
                                            id: String?)
package typealias UpdateSubcriberInfoList = (hash: String,
                                            info: SubscriptionInfo,
                                            parms: [String: Any])

package enum PERouter {
    ...
    private func getURL() -> URL {
        ...
        case .getImage(let path):
            do {
                ...
                let userDefaults = PECoreServices.getUserDefaults()
