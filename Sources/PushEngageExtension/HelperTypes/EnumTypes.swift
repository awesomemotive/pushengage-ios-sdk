...
package enum PermissionStatus: String {
...
package enum SiteStatus: String {
    case active
    case inactive
    case hold
    case delete
...
// basically  using for the postback data as it is not confirmed
struct AnyCodable: Decodable {
    package var value: Any
    
    package struct CodingKeys: CodingKey {
