...
package enum RetryApi {
    case allow
    case denied
}

package struct Utility {
    
    static var getBundleIdentifier: String {
        return Bundle.main.bundleIdentifier ?? ""
    }

    package static var getApplicationName: String {
    ...
    package static var timeZone: String {
        let identifier = TimeZone.current.identifier
        return identifier
    }

    package static func convert(data: Data) throws -> Parameters? {
    ...
    package static var inAppPermissionStatus: Bool {
    ...
    package static var autoHandleDeeplinkURL: Bool {
    ...
    package static func isPEPayload(userInfo: [AnyHashable: Any]) -> Bool {
    ...
    @available(iOS 10.0, *)
    package static func addButtonTo(withNotification: PENotification,
    ...
    package static func isNotifiyIsDisplayable(userInfo: [AnyHashable: Any]) -> Bool {
    ...
    @available(iOS 10.0, *)
    package static func createUNNotificationRequest(notification: PENotification,
    ...
    package static func checkForDuplicateProcess(infoDict: [AnyHashable: Any], lastRecivedNotifyId: String ) -> String {
    ...
    package static func isBackgroundFetchEnable() -> Bool {
    ...
    package static func retryCheck(error: PEError) -> RetryApi {
    ...
    @available(iOS 10.0, *)
    package static func isDismissEvent(response: UNNotificationResponse) -> Bool {
