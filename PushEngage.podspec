Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/awesomemotive/pushengage-ios-sdk-internal.git"
  spec.license =  { :type => "MIT", :file => "LICENSE" }
  spec.author  = { "PushEngage" => "care@pushengage.com" }
  spec.platform = :ios
  spec.ios.deployment_target  = '9.0'
  spec.requires_arc = true
  spec.source = { :git => "https://github.com/awesomemotive/pushengage-ios-sdk-internal.git",
                  :tag => "#{spec.version}"
                }
