...
package final class NotificationLifeCycleManager: NotificationLifeCycleServiceType {
    
    private let networkRouter: NetworkRouterType
    private let datasource: DataSourceType
    private let userDefault: UserDefaultsType
    private let backgroundTask: BackgroundTaskProviderType

    package init(networkRouter: NetworkRouterType,
                datasource: DataSourceType,
                userDefault: UserDefaultsType,
                backgroundTask: BackgroundTaskProviderType) {
    ...
    package func withRetrynotificationLifecycleUpdate(with action: NotificationAction,
                                              deviceHash: String,
                                              notificationId: String,
                                              actionid: String?,
                                              completionHandler: NotificationCallResponse<Bool>?) {
        backgroundTask.run { background in
    ...
    package func withRetrysponseredNotification(with notification: PENotification,
